...
![Crea archivo `Rmd`](images/create-rmd.png){#fig-create-rmd}

![Define detalles generales `Rmd`](images/create-rmd2.png){#fig-create-rmd-details}
...
![Encabezado YAML](images/ymal-exmaple.png){#fig-ymal-example}
...
| Imágenes | `![Descripción\](url a la imagen)` | Una imagen ![image](images/logo-rmd.png) |
